...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( ProductResponseModel data)?  success,TResult Function( ErrorHandler error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( ProductResponseModel data)  success,required TResult Function( ErrorHandler error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( ProductResponseModel data)?  success,TResult? Function( ErrorHandler error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Loading implements AddProductState {
  const Loading();
...
class Success implements AddProductState {
...
@override
String toString() {
  return 'AddProductState.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $AddProductStateCopyWith<$Res> {
...
class Error implements AddProductState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $AddProductStateCopyWith<$Res> {
