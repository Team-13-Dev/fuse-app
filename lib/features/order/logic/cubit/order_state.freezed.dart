...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<OrderResponseModel> orders)?  success,TResult Function( AddOrderResponseModel order)?  successCreate,TResult Function()?  successDelete,TResult Function( ErrorHandler error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.orders);case SuccessCreate() when successCreate != null:
return successCreate(_that.order);case SuccessDelete() when successDelete != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<OrderResponseModel> orders)  success,required TResult Function( AddOrderResponseModel order)  successCreate,required TResult Function()  successDelete,required TResult Function( ErrorHandler error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.orders);case SuccessCreate():
return successCreate(_that.order);case SuccessDelete():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<OrderResponseModel> orders)?  success,TResult? Function( AddOrderResponseModel order)?  successCreate,TResult? Function()?  successDelete,TResult? Function( ErrorHandler error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Success implements OrderState {
  const Success(final  List<OrderResponseModel> orders): _orders = orders;
...
class SuccessCreate implements OrderState {
  const SuccessCreate(this.order);
  

 final  AddOrderResponseModel order;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SuccessCreate&&(identical(other.order, order) || other.order == order));
}
...
@override
String toString() {
  return 'OrderState.successCreate(order: $order)';
}
...
class SuccessDelete implements OrderState {
  const SuccessDelete();
...
@override
String toString() {
  return 'OrderState.successDelete()';
}
